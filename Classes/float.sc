+ Float {
	...
	reverb  { | room=0.5, damp=0.5 | ^{arg sig; FreeVerb.ar(sig, this, room, damp)}}
	...
	moogvcf { | res=0.7 |  ^{arg sig; MoogVCF.ar(sig, this, Ziva.ndef(res) ? res, mul: 1)} }
	...
	distor  { | fold=1 	| ^{arg sig; sig = sig * this; sig.fold(fold.neg,fold)} }
	compress{ | below=1.0, above=4.0, atk=0.01, rel=0.1, amt=1.0	| ^{arg sig; Compander.ar(4*(sig),sig,this,below,above,atk,rel,mul:amt)} }
	limiter{ | dur=0.1	| ^{arg sig; Limiter.ar(sig, this, dur) * (-6.dbamp)} }
	// compress{ | threshold=0.4, below=1, above=0.5 | ^{arg sig; Compander.ar(sig, sig, threshold, below, above, 0.01, 0.01) }}
	amp	{ ^{arg sig; sig * this} }
	am	{ ^{arg sig; sig * this} }
}